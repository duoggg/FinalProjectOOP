	...
	void searchButtonPressed(ActionEvent event) {
		...
		if(marketplace.getValue()   == null) {
		  ...
		  for(int i = 0; i < data.length() ;i++) {	
				...
				ItemCollectionController newItem = new ItemCollectionController() ;
				newItem.loadData(jsonObject);
				newItem.getRoot().addEventFilter(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
					@Override
				...
				showArea.getChildren().add(newItem.getRoot());
			}
		  }
		}
	}
